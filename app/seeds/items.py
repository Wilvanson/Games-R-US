...
def seed_items():
    ...
    i2 = Item(in_stock=6, name= 'Tony Hawks Pro Skater 1 + 2', type='Video Game', cost=60, description= 'Tony Hawks Pro Skater 1 + 2 is a skateboarding video game played in a third-person view with its gameplay oriented towards classic arcade games. As such, the goal of most modes of the game is to achieve a high score or collect certain objects.',
     image='https://upload.wikimedia.org/wikipedia/en/8/8f/Tony_Hawk_Pro_Skater_Remaster_cover_art.png')
    i3 = Item(in_stock=1, name= 'Xbox Series X', type='Console', cost=60, description= 'The Xbox Series X has higher end hardware and supports higher display resolutions (up to 8K resolution), along with higher frame rates and real-time ray tracing; it also has a high-speed solid-state drive to reduce loading times.',
